...
function preload(){
    ...
    game.load.tilemap('begin','assets/firstMap.json',null,phaser.tilemap.tiled.json);

    game.load.image('tiles','assets/magecity.png');
...
function create(){
    ...
    map = game.add.tilemap('begin');
    
    map.addTilesetImage('magecity','tiles');

    layer = map.createLayer('lume');
