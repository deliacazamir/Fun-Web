...
Credits.prototype = {
  ...
  create: function () {
    ...
    this.addCredit('Music', 'The internet');
    this.addCredit('Developer', 'Mihai');
    this.addCredit('Developer', 'Delia');
    this.addCredit('Developer', 'Cosmin');
    this.addCredit('Developer', 'Ionut');
